...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTAur88gOU6Ychvl1T0s3-oG4WgztMsgblrQ&usqp=CAU);
...
<body>
    <div class="mdl-layout mdl-layout--fixed-header mdl-js-layout ">
        <header class="mdl-layout__header mdl-layout__header--scroll mdl-color-text--grey-800">
            <div class="mdl-layout__header-row">
                <span class="mdl-layout-title">FREE IMAGE HOSTING ❤️</span>
                <div class="mdl-layout-spacer"></div>
                <a style="color:#000;margin:5px;font-size:45px" href="https://t.me/KAAL_VEER" target="_blank">
                    <span style="font-size: 28px;" class="material-icons"></span>
                </a>
            </div>
        </header>
  ...
  <div align="center"> <button class="upload_file mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored">
        ...
        <footer>
        <div align="center">
               Made by : <a href="https://t.me/KAAL_VEER" target="_blank">KAALVEER</a></p>
